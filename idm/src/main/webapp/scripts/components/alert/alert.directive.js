                ...
                function($scope) {
                    ...
                    var cleanHttpErrorListener = $rootScope.$on('idmApp.httpError', function (event, httpResponse) {
                        ...
                        switch (httpResponse.status) {
                            ...
                            case 400:
                                var errorHeader = httpResponse.headers('X-idmApp-error');
                                var entityKey = httpResponse.headers('X-idmApp-params');
                                if (errorHeader) {
                                    ...
                                    for (i = 0; i < httpResponse.data.fieldErrors.length; i++) {
                                        ...
                                        var fieldName = $translate.instant('idmApp.' + fieldError.objectName + '.' + convertedField);
